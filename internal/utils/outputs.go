...
//go:generate $GOPATH/bin/mockgen -source=outputs.go -destination ../mocks/utils.go -package mocks -self_package github.com/khulnasoft-lab/go-application-framework/internal/utils/
