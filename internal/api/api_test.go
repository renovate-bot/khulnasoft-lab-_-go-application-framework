...
func Test_GetDefaultOrgId_ReturnsCorrectOrgId(t *testing.T) {
	...
	server := setupSingleReponseServer(t, "/rest/self?version="+constants.VULNMAP_API_VERSION, selfResponse)
		...
		Organizations: []contract.Organization{
			{
				...
				Slug:  "default-org",
				URL:   "https://api.khulnasoft.com/org/default-org",
				Group: nil,
			},
			{
				Name: "secondOrg",
				...
				Slug: "second-org",
				URL:  "https://api.khulnasoft.com/org/second-org",
	...
	return contract.SelfResponse{
		Data: contract.SelfResponseData{
			...
			Attributes: contract.SelfResponseDataAttribute{
				...
				Email:             "testy.mctestface@khulnasoft.com",
			},
		},
	}
}
