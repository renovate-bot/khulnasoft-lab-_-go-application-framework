...
import (
	...
	"github.com/khulnasoft-lab/go-application-framework/internal/mocks"
...
func Test_CreateAppEngine(t *testing.T) {
	...
	expectApiUrl := constants.VULNMAP_DEFAULT_API_URL
...
func Test_initConfiguration_existingValueOfOAuthFFRespected(t *testing.T) {
	existingValue := false
	endpoint := "vulnmap.khulnasoft.com"
...
func Test_initConfiguration_vulnmapgov(t *testing.T) {
	endpoint := "vulnmap.khulnasoft.com"
...
func Test_initConfiguration_NOT_vulnmapgov(t *testing.T) {
	endpoint := "https://api.eu.khulnasoft.com"
