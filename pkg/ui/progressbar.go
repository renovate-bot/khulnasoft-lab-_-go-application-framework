...
//go:generate $GOPATH/bin/mockgen -source=progressbar.go -destination ../mocks/progressbar.go -package mocks -self_package github.com/khulnasoft-lab/go-application-framework/pkg/ui/
