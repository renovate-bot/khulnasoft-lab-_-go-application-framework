...
//go:generate $GOPATH/bin/mockgen -source=authenticator.go -destination ../mocks/authenticator.go -package mocks -self_package github.com/khulnasoft-lab/go-application-framework/pkg/auth/
