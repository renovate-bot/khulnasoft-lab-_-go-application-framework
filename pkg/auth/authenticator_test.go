...
func Test_IsKnownOAuthEndpoint(t *testing.T) {
	assert.True(t, IsKnownOAuthEndpoint("vulnmap.khulnasoft.com"))
	assert.True(t, IsKnownOAuthEndpoint("vulnmap.khulnasoft.com/"))
	assert.True(t, IsKnownOAuthEndpoint("vulnmap.khulnasoft.com/some/path/"))
	assert.True(t, IsKnownOAuthEndpoint("https://www.vulnmapgov.io/"))
	assert.False(t, IsKnownOAuthEndpoint("https://khulnasoft.com"))
	assert.False(t, IsKnownOAuthEndpoint("https://khulnasoft.com/"))
	assert.False(t, IsKnownOAuthEndpoint("https://khulnasoft.com/"))
}
